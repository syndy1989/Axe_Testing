...
public JSONArray run_axe(WebDriver driver,URL scriptUrl) throws JSONException {
JSONArray violations = null;
JSONObject responseJSON = new AXE.Builder(driver, scriptUrl).analyze();
violations = responseJSON.getJSONArray("violations");
return violations;
}
public String Sub_String_url(String urlString, int count){
...
public String dynamic_filecreation(String map,JSONArray results){
File file;
